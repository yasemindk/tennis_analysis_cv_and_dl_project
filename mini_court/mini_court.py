...
class MiniCourt():
    ...
    def draw_background_rectangle(self,frame):
        ...
        # draw rectangle
        cv2.rectangle(shapes, (self.start_x, self.start_y), (self.end_x, self.end_y), (255,255,255), -1) # -1 = cv2.FILLED
        out = frame.copy()
        alpha=0.5 # %50 transparent
        mask=shapes.astype(bool)
        out[mask] = cv2.addWeighted(frame, alpha,shapes, 1-alpha, 0)[mask] # 0=filled
    ...
    def get_mini_court_coordinates(self, 
        ...
        # get the distance between closest_keypoint and player
    ...
    def draw_point_on_mini_court(self, frames, positions,color=(0,255,0)):
